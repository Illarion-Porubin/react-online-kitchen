        ...
        <section className={s.about}>
          <div className={s.mainInfo}>
            ...
            <div className={s.info}>
              ...
              <p>
                После выпуска решил обучаться программированию, так как мне это
                было интересно, да и зарплата была на порядок выше.
                <br />С тех пор я прокачиваю себя в этом направлении, изучаю
                новые технологии, слежу за обновлениями в React, улучшаю
                английский.
              </p>
              <p>
                Вот уже 4 года я занимаюсь веб разработкой, за это время было
                созданно много проектов различной сложности начиная от
                одностраничника с использованием Gulp и заканчивая интернет
                магазином с пременением React, Redux, Redux-toolkit,
                Redux-persist, React-router-dom, Axios, MySql, Sequelize,
                Passport-google-oauth20 и прочими технологиями.
              </p>
              <p>
                Я не проходил обучение в различных “онлайн школах” где за 6
                месяцев из тебя якобы сделают гуру web или back разработки, так
                как всё это очень сомнительно. <br /> Информацию для обучения
                беру из докуменаций, открытых источников и на YouTub. Весь мой
                труд постигался долгие 4 года, за это время я успел поработать
